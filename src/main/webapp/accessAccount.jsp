...
<form action = "accessAccountServlet"  method = "post" style = "text-align: center;">
  <h1 style="text-align: center;" style="font-size: 40px;">Doriti sa intrati in contul cu iban-ul</h1>
 ...
 <input type="submit" style="width: 350px; height: 75px;  background-color: #008080; color: #fff;" value="Accesati">
  </form>
</body>
</html>